        ...
        sidebarPanel(
                        tags$div(
                                HTML("<strong>Welcome to our Shiny App, here is a little guide to our app:</strong> </br></br>
                                 - Load our latest dataset of Indeed Job listings. An initial map with all the job listings in Switzerland will be displayed.
                               </br> </br>- If you would like to filter by Job Category, make sure to select them and click the <strong>Confirm Choice </strong> button.
                              </br> </br> - Selecting the <strong>Map With Selected Categories</strong> option will display the map with the filters you chose.
                              </br> </br> - You can update the map with the filters by clicking on <strong>Confirm Choice</strong> and having the <strong>Map
